...
CREATE TABLE `discount` (
  ...
  `CouponCode` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `MaximumDiscountedQuantity` int DEFAULT NULL,
...
-- Dump completed on 2020-10-14 22:55:52
