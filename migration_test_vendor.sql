...
CREATE TABLE `vendor` (
  ...
  `PageSizeOptions` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SystemName` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `IsSubscriptionBased` tinyint(1) NOT NULL,
  PRIMARY KEY (`Id`)
